...
tags: ["query:peft"]
score: 9.0
evidence: 通过稀疏且正交的 LoRA 进行联邦微调
tldr: 本研究针对无线去中心化联邦学习中大语言模型多任务微调面临的知识遗忘、通信效率低及任务干扰等挑战，提出了一种基于稀疏正交LoRA的微调框架。该框架通过确保模型更新的正交性消除冲突，结合基于聚类的拓扑设计优化聚合过程，并引入隐式专家混合（MoE）机制解决推理时的知识干扰，显著提升了多任务协作微调的效率与性能。
selection_source: fresh_fetch
motivation: 旨在解决去中心化联邦学习在多任务微调中存在的知识遗忘、通信带宽压力及推理阶段的任务干扰问题。
method: 提出稀疏正交LoRA以消除更新冲突，并结合聚类拓扑优化与隐式MoE机制来提升聚合效率和推理表现。
result: "实验表明，该方法相比传统LoRA可减少高达73%的通信资源消耗，并将平均性能提升5%。"
conclusion: 该方案有效解决了无线环境下多任务联邦微调的冲突与效率难题，为移动设备协作微调大模型提供了高效的去中心化路径。
---
